...
let audiofiles=[
  'Marathi_songs/A_Savita_Aga_Savita.mp3','Marathi_songs/Aai_Tujha_deul.mp3','Marathi_songs/Aamdar_Zalya_Sarkha_Vatatay.mp3',
  'Marathi_songs/Aaple_Saheb_Thackrey.mp3','Marathi_songs/Aatach_Baya_Ka_Baavarla.mp3','Marathi_songs/Aho_Mami_Tumchi_Mulagi_Lay_Sundar.mp3',
  'Marathi_songs/Apsara_Aali.mp3','Marathi_songs/Bablya_Ekas_Kesavar_Fuge.mp3','Marathi_songs/Bhau_-_Shambu.mp3',
  'Marathi_songs/Fandry_Song.mp3','Marathi_songs/Gondhal.mp3','Marathi_songs/Govyachya_Kinaryav.mp3',
  'Marathi_songs/Gulabachi_Kali.mp3','Marathi_songs/Hi_Poli_Saajuk.mp3','Marathi_songs/Halad_Lagali.mp3',
  'Marathi_songs/Ishkkachi_Nauka.mp3','Marathi_songs/Ka_Kalena.mp3','Marathi_songs/Khel_Mandala.mp3',
  'Marathi_songs/Koliwada_Jhingla.mp3','Marathi_songs/Kombadi_Palali.mp3','Marathi_songs/Mala_Ved_Lagale.mp3',
  'Marathi_songs/O_kaka.mp3','Marathi_songs/O_Raje.mp3','Marathi_songs/Pune_RAP.mp3',
  'Marathi_songs/Saavar_Re_Mana.mp3', 'Marathi_songs/Sairat_Zala_Ji.mp3','Marathi_songs/Shantabia.mp3',
  'Marathi_songs/Shitti_Vajali.mp3','Marathi_songs/TAN_TAN_BHAN_BHAN.mp3','Marathi_songs/Tola_Tola.mp3',
  'Marathi_songs/Tu_Chal_Re_Mana.mp3','Marathi_songs/Wajle_Ki_Bara.mp3','Marathi_songs/Yad_Lagla.mp3',
  'Marathi_songs/Zingat.mp3','Marathi_songs/Khulach_Zalo_Ga.mp3','Marathi_songs/Zindagi_Zindagi.mp3',
  'Marathi_songs/Jiv_Rangala.mp3','Marathi_songs/Man_Udhan_Varyache.mp3','Marathi_songs/Tu_Hi_Re_Maza_Mitva.mp3','Marathi_songs/Hrudayat_Vaje_Something.mp3','Marathi_songs/Rakhumai_Rakhumai.mp3','Marathi_songs/Sur_Niragas_Ho.mp3','Marathi_songs/Saath_De_Tu_Mala.mp3','Marathi_songs/Kitida_Navyane_Tula_Athvave.mp3','Marathi_songs/Deva_Thujha_Gabharyala.mp3','Marathi_songs/Bulati_Hai_Magar_Jane_Ka_Nahi.mp3'
];
